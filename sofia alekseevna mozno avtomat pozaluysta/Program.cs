...
namespace Pract10
{
    public class Program
    {
        static void Main(string[] argrs)
        {
            ...
            {
                Console.Clear();
                UserSeller UserSeller = new UserSeller(workers, con);
                UserSeller.Interface();
            }

            if (workers.atribute == 4)
            {
                Console.Clear();
                UserWarehouseManager UserWarehouseManager = new UserWarehouseManager(workers, con);
                UserWarehouseManager.Interface();
            }
